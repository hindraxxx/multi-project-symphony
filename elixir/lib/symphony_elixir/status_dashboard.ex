defmodule SymphonyElixir.StatusDashboard do
    ...
    project_part =
      case settings.tracker.project_slug do
        project_slug when is_binary(project_slug) and project_slug != "" ->
          colorize(linear_project_url(settings.tracker, project_slug), @ansi_cyan)
  ...
  defp linear_project_url(%{workspace_slug: workspace_slug}, project_slug)
       when is_binary(workspace_slug) and workspace_slug != "" do
    "https://linear.app/#{workspace_slug}/project/#{project_slug}/issues"
  end

  defp linear_project_url(_tracker, project_slug), do: "https://linear.app/project/#{project_slug}/issues"
